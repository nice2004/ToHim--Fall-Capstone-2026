      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              ...
              multiple groups. You can also query groups in Ask ToHim (for example, which of your mentors
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            accessibilityHint="How ToHim handles your information and security"
          >
            <View style={styles.accountRowTextWrap}>
